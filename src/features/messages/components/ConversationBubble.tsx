...
const ConversationBubble = ({ bubble }: ConversationBubbleProps) => {
	...
	return (
		<div className={clsx("flex w-full flex-col gap-1", isRight ? "items-end" : "items-start")}>
			<div className="max-w-[92%] rounded-2xl bg-accent px-4 py-3 text-sm text-white shadow-sm sm:max-w-xl">
				<p className="whitespace-pre-line break-words leading-6">{bubble.text}</p>
			</div>
