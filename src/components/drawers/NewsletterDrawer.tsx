import { Drawer, DrawerBody, DrawerContent, DrawerFooter, DrawerHeader, Input, Textarea } from "@heroui/react"
					...
					<div className="flex h-full flex-col px-12 py-10">
						...
						<DrawerBody className="flex-1 overflow-y-auto py-6">
							<div className="flex flex-col gap-6">
								<Input label="Title" placeholder="Give your newsletter a name" />
								<Input label="Subject line" placeholder="Add a subject to preview in inboxes" />
								<Textarea
									label="Content"
									minRows={8}
