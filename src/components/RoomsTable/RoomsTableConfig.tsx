...
const createRoomsColumns = (): TableColumn<Room>[] => [
	...
	},
	{
		key: "capacity",
		label: "Capacity",
		renderCell: (room) => <span className="text-sm text-gray-600">{room.capacity}</span>,
	},
	{
		key: "students",
		label: "Students",
		renderCell: (room) => <span className="text-sm text-gray-600">{room.studentsCount}</span>,
	},
	{
		key: "staff",
		label: "Staff",
		renderCell: (room) => <span className="text-sm text-gray-600">{room.staffCount}</span>,
	},
	{
		key: "signInStudents",
