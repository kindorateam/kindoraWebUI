...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
	...
	override componentDidCatch(error: Error, errorInfo: ErrorInfo) {
		...
		this.setState({
			errorInfo,
			errorBoundaryStack: [...(this.state.errorBoundaryStack ?? []), level ?? "unknown"],
		})
	}
	...
	override render() {
		...
		if (hasError && error) {
			...
			if (isolate) {
				...
				return <ErrorFallback error={error} errorInfo={errorInfo ?? undefined} resetError={this.resetError} />
			}
