	...
	return (
		<div>
			<SubHeader
				...
				endSlot={
					<Button color="primary" onPress={handleOpenCreateDrawer} startContent={<NewsIconAdd />}>
						Create New
					</Button>
				}
			/>
			...
			<NewsletterDrawer isOpen={isCreateDrawerOpen} onClose={handleCloseCreateDrawer} />
		</div>
	)
}
