...
const messagesData: MessageRow[] = [
		...
		parents: [
			{
				id: "p1",
				name: "Parent 1",
				avatar: "https://images.unsplash.com/photo-1494790108755-2616b612b17c?w=64&h=64&fit=crop&crop=faces",
			},
		],
		preview:
	...
	},
	{
		...
		student: {
			name: "Emily Carter",
			avatar: "https://images.unsplash.com/photo-1529665253569-6d01c0eaf7b6?w=80&h=80&fit=crop&crop=faces",
			online: true,
		},
		parents: [
			{
	...
	},
	{
		...
		student: {
			name: "Olivia Hayes",
			avatar: "https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?w=80&h=80&fit=crop&crop=faces",
			online: true,
		},
		parents: [
			{
	...
	},
	{
		...
		student: {
			name: "Sophie Bennett",
			avatar: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=80&h=80&fit=crop&crop=faces",
		},
		parents: [
			{
				id: "p7",
...
const columns: TableColumn<MessageRow>[] = [
	{
		...
		renderCell: (row) => (
			<div className="flex items-center gap-3">
				{/* Unread dot */}
				<span className={`h-2.5 w-2.5 rounded-full ${row.student.unread ? "bg-brand" : "bg-transparent"}`} />
	...
	},
	{
		...
		label: "",
		align: "end",
		renderCell: (row) => <span className="text-default-400 text-sm">{row.time}</span>,
	},
]
